...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_5.setPixmap(QtGui.QPixmap(":/icon/thermometer.svg"))
...
"selection-color: rgb(170, 255, 0);")
        ...
        self.clean_button = QtWidgets.QPushButton(self.widget_3)
        self.clean_button.setMinimumSize(QtCore.QSize(0, 30))
        self.clean_button.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.Historic_button = QtWidgets.QPushButton(self.widget_7)
        self.Historic_button.setMinimumSize(QtCore.QSize(50, 30))
        self.Historic_button.setObjectName("Historic_button")
        self.horizontalLayout_4.addWidget(self.Historic_button)
        self.data_label = QtWidgets.QLabel(self.widget_7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Temperature Historic Data"))
        ...
        self.clean_button.setText(_translate("MainWindow", "Clean List"))
